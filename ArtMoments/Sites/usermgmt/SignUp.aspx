...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        .invalidMsgMargin { margin-left: 2em; }
        ...
        <div class="myCard">
            <div class="row">
                ...
                <div class="col-md-6" id="loginDesc">
                    <div>
                        <div class="box">
                            <header style="color: antiquewhite; font-size: 25px; font-family: 'Book Antiqua';">Welcome to Art Moments</header>
                            <br/><br/><br/><br/>
                            <p style="color: floralwhite; padding: 10px">
