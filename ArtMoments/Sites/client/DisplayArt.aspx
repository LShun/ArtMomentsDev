...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        .search-form-group label { font-size: 60%; }

        .auto-style3 { margin-left: 0px; }
    </style>
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-3 form-group search-form-group">
                    ...
                    <asp:TextBox ID="txtMinPR" runat="server" CssClass="form-control search-form-control"
                                 MaxLength="10" MinLines="1" MaxLines="1" autocomplete="off">
                    </asp:TextBox>
                    <asp:RegularExpressionValidator ID="revTxtMinPR" runat="server"
                                                    ErrorMessage="Minimum Price Range only accept integer value"
                                                    ValidationExpression="^[1-9]\d*(\.\d+)?$" ControlToValidate="txtMinPR" ForeColor="Red">
                ...
                <div class="col-3 form-group search-form-group">
                    ...
                    <asp:RegularExpressionValidator ID="revTxtMaxPR" runat="server"
                                                    ...
                                                    ValidationExpression="^[1-9]\d*(\.\d+)?$" ControlToValidate="txtMaxPR" ForeColor="Red">
                    </asp:RegularExpressionValidator>
                ...
                <div class="col-3 form-group search-form-group">
                    ...
                    <asp:TextBox ID="txtProdName" runat="server" CssClass="form-control search-form-control"
                                 MaxLength="50" MinLines="1" MaxLines="1" autocomplete="off">
                    </asp:TextBox>
                    <asp:RegularExpressionValidator ID="revTxtProdName" runat="server"
                                                    ErrorMessage="Only alphabet is allowed for Product Name"
                                                    ValidationExpression="^[a-zA-Z]+$" ControlToValidate="txtProdName" ForeColor="Red">
                    </asp:RegularExpressionValidator>
        ...
        <div ID="display-img-container">
            ...
            <table id="tbPaging" runat="server" style="width: 100%; margin: 2% 0% 0% 4%">
                <tr>
                    <td>
                        <asp:Button CssClass="btnPaging" ID="btnFirst" runat="server" Font-Bold="true" Text="First" OnClick="btnFirst_Click"/>
                    </td>
                    <td>
                        <asp:Button CssClass="btnPaging" ID="btnPrevious" runat="server" Font-Bold="true" Text="Previous" OnClick="btnPrevious_Click"/>
                    </td>
                    <td>
                        <asp:Button CssClass="btnPaging" ID="btnNext" runat="server" Font-Bold="true" Text="Next" OnClick="btnNext_Click" style="height: 48px"/>
                    </td>
                    <td>
                        <asp:Button CssClass="btnPaging" ID="btnLast" runat="server" Font-Bold="true" Text="Last" OnClick="btnLast_Click"/>
                    </td>
                </tr>
            </table>
            <br/>
