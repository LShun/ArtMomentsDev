<%@ Page Title="Add Product" Language="C#" MasterPageFile="~/Masters/Artist1.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="ArtMoments.Sites.artist.AddProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="addArtwork">
        <div class="container">
            ...
            <div class="row">
                <div class="col-2">
                    <label for="artworkHeight">Artwork Height (cm)*:</label>
                </div>
                <div class="col-4">
            ...
            <div class="row">
                <div class="col-2">
                    <label for="artworkDesc">Artwork Description*:</label>
                </div>
                <div class="col-10">
            ...
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <asp:SqlDataSource ID="test" runat="server" ConnectionString="Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=ArtMomentsDb;Integrated Security = True"
                                       SelectCommand="Select ID, category_name from product_category">
                    </asp:SqlDataSource>
                </div>
            ...
            <div class="row">
                <div class="col-2">
                    <label for="artworkPrice">Artwork Price (RM)*:</label>
                </div>
                <div class="col-10">
            ...
            <div class="row">
                <div class="col-2">
                    <label for="artworkStock">Artwork Stock*:</label>
                </div>
                <div class="col-10">
                    <asp:TextBox ID="txtArtworkStock" MaxLength="20" onkeypress="return onlyNumberKey(event)" runat="server" autocomplete="off"></asp:TextBox>
                </div>
            </div>
            <div class="row">
